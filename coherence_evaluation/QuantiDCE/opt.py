...
def parse_coherence_eval_opt():
    parser = argparse.ArgumentParser()

    parser.add_argument('--eval_data_dir_path',
    ...
    parser.add_argument('--checkpoint_dir_path',
                        help='The path of the output checkpoint directory.')
    parser.add_argument('--checkpoint_file_name',
    ...
    parser.add_argument(
        ...
        '--input_file_path',
        type=str,
        help='The path of the input file to be compute the coherence score.')
    parser.add_argument(
        '-o',
        '--output_file_path',
        type=str,
        help='The path of the output file to save the coherence score.')
...
def parse_pretrain_opt():
    ...
    parser.add_argument('--inter_distance_lower_bound',
                        type=float,
                        help='The lower bound of the inter-cluster distance.')
    parser.add_argument('--intra_distance_upper_bound',
                        type=float,
    ...
    parser.add_argument('--score_loss_weight',
                        type=float,
                        default=1.,
                        help='The loss weight for score_mlr_loss.')
    parser.add_argument('--bce_loss_weight',
                        type=float,
                        default=1.,
    ...
    parser.add_argument(
        '--monitor_metric_name',
        choices=[
            'acc', 'mlr_loss', 'dual_mlr_loss', 'dual_fat_loss',
    ...
    parser.add_argument('--centroid_mode',
                        choices=['mean'],
...
def parse_finetune_opt():
    ...
    parser.add_argument(
        ...
        type=float,
        help='The warmup proportion of the warmup strategy for LR scheduling.')
    parser.add_argument('--kd_loss_weight',
                        type=float,
                        default=1.,
                        help='The loss weight for kd_loss.')
    parser.add_argument('--finetune_loss_weight',
                        type=float,
                        default=1.,
    ...
    parser.add_argument('--pretrain_checkpoint_file_name',
                        help='The file name of the checkpoint to be loaded.')
    parser.add_argument('--logging_level',
                        choices=['INFO', 'DEBUG'],
                        help='The output logging level.')
