...
\SetAdvisorNameA{高宏宇}{Hung-Yu Kao}
...
\SetOralImageChi{oral-chi.pdf}   % 中文版檔案
% \SetOralImageEng{學位考試異動單.pdf}   % 英文版檔案
...
\SetKeywords{Dialogue System}{Personalization}{Personalized Dialogue Generation}{Dialogue Graph}{Discourse Relation}{Persona-consistency}
...
\SetAbstractChiKeywords{對話系統}{個人化}{個人化對話生成}{對話圖}{語篇關係}{角色一致性}
\SetAbstractEngKeywords{Dialogue System}{Personalization}{Personalized Dialogue Generation}{Dialogue Graph}{Discourse Relations}{Persona-consistency}
% ----------------------------------------------------------------------------
